        ...
        <div class="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-6 flex flex-col overflow-y-auto">
          ...
          <form class="mt-4">
            <div class="border-t border-gray-200 px-4 py-6">
              ...
              <div id="filter-section-0" class="pt-6">
                <div class="space-y-6">
            ...
            <div class="border-t border-gray-200 px-4 py-6">
              ...
              <div id="filter-section-1" class="pt-6">
                <div class="space-y-6">
                  <div class="flex items-center">
            ...
            <div class="border-t border-gray-200 px-4 py-6">
              ...
              <div id="filter-section-2" class="pt-6">
                <div class="space-y-6">
                  <div class="flex items-center">
            ...
            <div class="border-t border-gray-200 px-4 py-6">
              ...
              <div id="filter-section-3" class="pt-6">
                <div class="space-y-6">
                  <div class="flex items-center">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="filter-mobile-sizes-3" class="ml-3 text-sm text-gray-500">
                      L
                    </label>
                  </div>
          ...
          <section aria-labelledby="filter-heading" class="border-t border-gray-200 pt-6">
            ...
            <div class="flex items-center justify-between">
              <div class="relative z-10 inline-block text-left">
                <div>
                  <button id="menu-button" type="button" class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" aria-expanded="false" aria-haspopup="true">
                    Sort
                    <!-- Heroicon name: solid/chevron-down -->
              ...
              -->
                <div class="origin-top-left absolute left-0 z-10 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                  <div class="py-1" role="none">
                    ...
                    <a id="menu-item-0" href="#" class="block px-4 py-2 text-sm font-medium text-gray-900" role="menuitem" tabindex="-1">
                      Most Popular
                    </a>

                    <a id="menu-item-1" href="#" class="block px-4 py-2 text-sm font-medium text-gray-900" role="menuitem" tabindex="-1">
                      Best Rating
                    </a>

                    <a id="menu-item-2" href="#" class="block px-4 py-2 text-sm font-medium text-gray-900" role="menuitem" tabindex="-1">
                      Newest
                    </a>

                    <a id="menu-item-3" href="#" class="block px-4 py-2 text-sm font-medium text-gray-900" role="menuitem" tabindex="-1">
                      Price: Low to High
                    </a>

                    <a id="menu-item-4" href="#" class="block px-4 py-2 text-sm font-medium text-gray-900" role="menuitem" tabindex="-1">
                      Price: High to Low
                    </a>
                  </div>
                </div>
