...
<head>\r
  ...
  <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#00aba9">\r
  <meta name="msapplication-TileColor" content="#00aba9">\r
  <meta name="theme-color" content="#ffffff">\r
  <script>\r
    (function() {\r
      const prefersDark = window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches\r
      const setting = localStorage.getItem('vueuse-color-scheme') || 'auto'\r
      if (setting === 'dark' || (prefersDark && setting !== 'light'))\r
        document.documentElement.classList.toggle('dark', true)\r
    })()\r
  <\/script>\r
  <script type="module" crossorigin src="/assets/app.a5c1922c.js"><\/script>
  <link rel="modulepreload" href="/assets/vendor.5e53ca0f.js">
  <link rel="stylesheet" href="/assets/app.9dc7345e.css">
<link rel="manifest" href="/manifest.webmanifest"></head>\r
<body class="h-full">\r
  <div id="app"></div>\r
  \r
</body>\r
